...
const Upload = () => {
  ...
  return (
    <div
     ...
     left-0 top-[60px] mb-10
      pt-10 lg:pt-20 bg-[#F8F8F8] justify-center"
    >
      <div
        className="bg-white rounded-lg 
      xl:h-[80vh] w-[80%] flex gap-6 flex-wrap
       justify-between 
      ...
      >
        <div>
          ...
          <div
            className="transition-all border-dashed
             rounded-xl border-4 
            border-gray-200 
            flex flex-col justify-center
          items-center outline-none
           mt-10 w-[256px] h-[460px] p-10 cursor-pointer hover:border-red-300 hover:bg-gray-100"
          >
            {isLoading ? (
              <p>Uploading...</p>
            ) : (
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <select
            className="outline-none border-2 border-gray-200 text-md capitalize lg:p-2 p-1 rounded cursor-pointer"
          ...
          <div className="flex gap-6 mt-10">
            ...
            text-md font-medium p-
             rounded w-28 lg:w-44 outline-none"
              type="button"
              onClick={() => {}}
            >
              Discard
